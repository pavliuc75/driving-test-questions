...
export interface Question {
    "id": number,
    question: { "ro": string, "ru": string },
    image?: boolean,
    correctAnswer: { "id": number, explanation: { "ro": string, "ru": string } },
    answers: Array<{ "id": number, answer: { "ro": string, "ru": string } }>,
}
...
const questionsHelper = {
    ...
    getRandomQuestions: function (limit = 999): Array<Question & { categoryIdLiteral: string, secondaryId: number }> {
